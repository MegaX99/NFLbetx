...
export function HomeDashboard() {
  ...
  if (loading) {
    return <main className="mx-auto grid w-full max-w-6xl flex-1 place-items-center px-4 py-12"><div className="panel w-full p-10 text-center text-slate-500">Loading NFLbetxâ€¦</div></main>;
  }
      ...
      <main className="flex-1">
        <section className="overflow-hidden bg-slate-950 text-white">
          <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300">Create a private pickâ€™em pool, invite your friends, and compete against the point spread all season long.</p>
        ...
        <section id="how-it-works" className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
          ...
          <div className="mt-9 grid gap-5 md:grid-cols-3">
            {[
              ["1", "Join a pool", "Use a friendâ€™s invitation code, or create a pool of your own."],
  ...
  return (
    <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-8 sm:px-6 sm:py-12">
      <section className="overflow-hidden rounded-3xl bg-slate-950 px-6 py-8 text-white sm:px-9 sm:py-10"><p className="eyebrow text-lime-400">Your NFLbetx home</p><h1 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Welcome back, {displayName}.</h1><p className="mt-3 max-w-2xl text-slate-300">Hereâ€™s everything you need for Week 1.</p></section>
      ...
      {currentPool ? (
        <section className="mt-7 grid gap-5 lg:grid-cols-[1.35fr_.65fr]">
          ...
          <aside className="panel p-6 sm:p-8">
            ...
            <Link href="/history" className="mt-7 inline-flex font-black text-lime-700 hover:text-lime-800">View pick history â†’</Link>
          </aside>
        </section>
      ) : (
      ...
      <section className="mt-7 grid gap-4 sm:grid-cols-3">
        ...
        <Link href="/standings" className="panel p-6 transition hover:-translate-y-0.5 hover:shadow-md"><p className="eyebrow">Standings</p><p className="mt-2 text-xl font-black">See whoâ€™s leading</p></Link>
